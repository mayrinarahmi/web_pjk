<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->routeIs('kode-rekening.*') ? 'active open' : '' }}">
            <a href="{{ route('kode-rekening.index') }}" class="menu-link" wire:navigate>
                <i class="menu-icon tf-icons bx bx-code-block"></i>
                <div data-i18n="Kode Rekening">Kode Rekening</div>
            </a>
        </li>
        
        <li class="menu-item {{ request()->routeIs('target-bulan.*') ? 'active open' : '' }}">
            <a href="{{ route('target-bulan.index') }}" class="menu-link" wire:navigate>
                <i class="menu-icon tf-icons bx bx-target-lock"></i>
                <div data-i18n="Target Kelompok Bulan">Target Kelompok Bulan</div>
            </a>
        </li>
        
        <li class="menu-item {{ request()->routeIs('target-anggaran.*') ? 'active open' : '' }}">
            <a href="{{ route('target-anggaran.index') }}" class="menu-link"wire:navigate>
                <i class="menu-icon tf-icons bx bx-money"></i>
                <div data-i18n="Target Anggaran">Target Anggaran</div>
            </a>
        </li>
        ...
        <li class="menu-item {{ request()->routeIs('penerimaan.*') ? 'active open' : '' }}">
            <a href="{{ route('penerimaan.index') }}" class="menu-link" wire:navigate>
        ...
        <li class="menu-item {{ request()->routeIs('laporan.*') ? 'active open' : '' }}">
            <a href="{{ route('laporan.index') }}" class="menu-link" wire:navigate>
        ...
        <li class="menu-item {{ request()->routeIs('user.*') ? 'active open' : '' }}">
            <a href="{{ route('user.index') }}" class="menu-link" wire:navigate>
        ...
        <li class="menu-item {{ request()->routeIs('backup.*') ? 'active open' : '' }}">
            <a href="{{ route('backup.index') }}" class="menu-link" wire:navigate>
